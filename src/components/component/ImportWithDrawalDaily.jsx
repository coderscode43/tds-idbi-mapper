...
const ImportWithDrawalDaily = ({ subPanel, entity }) => {
    ...
    <>
      ...
      <div className="mt-5 rounded-md border border-gray-100 shadow-md">
        <div className="flex items-center-safe justify-between gap-2 p-5">
          {/* Generate Wrong Account Number Button  */}
          <button
          ...
          >
            <img
              ...
              className="h-[30px] mix-blend-multiply"
            />
            <span className="w-full text-[16px]">Get PAN</span>
          </button>
          <span>
            <i className="fa-solid fa-right-long text-gray-700"></i>
          </span>
          ...
          >
            ...
            />
            <span className="btntext text-[16px]">Get Transaction</span>
          </button>
        </div>
        <div className="flex items-center-safe justify-between gap-2 p-5">
          {/* Map Transaction  */}
          ...
          >
            ...
            />
            <span className="btntext text-[16px]">Generate RNR Report</span>
          </button>
          <span>
            <i className="fa-solid fa-right-long text-gray-700"></i>
          </span>
...
export default ImportWithDrawalDaily;
