...
const ImportWithDrawalMonthly = ({ subPanel, entity }) => {
        ...
        <div className="flex items-center-safe justify-between gap-2 p-5">
          ...
          >
            <img
              ...
              className="h-[30px] w-[35px] mix-blend-multiply"
            />
            <span className="btntext text-[16px]">Generate Over All Excel</span>
          </button>
        </div>
        <div className="flex items-center-safe justify-between gap-2 p-5">
          {/* GL Reconciliation */}
          ...
          >
            <img
              ...
              className="h-[30px] w-[35px] mix-blend-multiply"
            />
            <span className="btntext text-[16px]">Generate TTUM Report</span>
          </button>
          <span>
            <i className="fa-solid fa-right-long text-gray-700"></i>
          </span>
          ...
          >
            ...
            />
            <span className="btntext text-[16px]">Generate OA/OL Excel</span>
          </button>
          <span>
            <i className="fa-solid fa-right-long text-gray-700"></i>
          </span>
...
export default ImportWithDrawalMonthly;
