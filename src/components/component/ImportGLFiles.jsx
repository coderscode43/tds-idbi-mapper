  ...
  return (
    <>
      ...
      <div className="flex gap-5 rounded-md border border-gray-100 shadow-lg">
        {["GL Balance", "GL Transaction"].map((title) => (
          <div
            key={title}
            className="w-full flex-col items-center gap-5 p-5 focus:outline-none"
          >
            <h4 className="mb-4 text-[17px] font-semibold">Import {title}</h4>
            <div>
              <label className="content-between font-medium text-[var(--primary-color)]">
                Select Folder
              </label>
              <input
                type="file"
